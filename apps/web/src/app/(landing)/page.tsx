  ...
  return (
    <div className={styles.root}>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerTop}><span className={styles.wordmark}><span aria-hidden="true" />watchly</span><a href="https://x.com/WatchlyTV" target="_blank" rel="noreferrer">Find us on X <span aria-hidden="true">↗</span></a></div>
