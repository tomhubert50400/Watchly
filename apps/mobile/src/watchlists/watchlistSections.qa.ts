...
assert(resolveCarriedPosterTilt(500) < 0, 'the bottom of a poster carried to the right must lag to the left');
assert(resolveCarriedPosterTilt(-500) > 0, 'the bottom of a poster carried to the left must lag to the right');
